...
//test with X=Y=10000, T=200...X=Y=40000, T=10...X=Y=14000, T=100
const int X = 100;                         // Number of points along X-axis
const int Y = 100;                         // Number of points along Y-axis
...
int main() {
    ...
    const int T = 1'000'000'000;                         // Total number of time steps
